...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='orn_param', full_name='caffe.LayerParameter.orn_param', index=70,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bn_param', full_name='caffe.LayerParameter.bn_param', index=71,
...
_ORNPARAMETER = _descriptor.Descriptor(
  name='ORNParameter',
  full_name='caffe.ORNParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='orientations', full_name='caffe.ORNParameter.orientations', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['orn_param'].message_type = _ORNPARAMETER
...
DESCRIPTOR.message_types_by_name['ORNParameter'] = _ORNPARAMETER
...
ORNParameter = _reflection.GeneratedProtocolMessageType('ORNParameter', (_message.Message,), dict(
  DESCRIPTOR = _ORNPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.ORNParameter)
  ))
_sym_db.RegisterMessage(ORNParameter)
